...
use JobFinder\JobFinderBundle\Entity\Job;
...
class LoadJobData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $em)
    {
        ...
        $job_sensio_labs->setDescription('You\'ve already developed websites with symfony and you want to work with
            Open-Source technologies. You have a minimum of 3 years experience in web development with PHP or Java and
            you wish to participate to development of Web 2.0 sites using the best frameworks available.');
        ...
        $job_extreme_sensio->setDescription('Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
        ...
        $job_expired->setExpiresAt(new \DateTime('2021-10-10'));
        $job_expired->setCreatedAt(new \DateTime('2002-12-01'));
        ...
        for ($i = 100; $i <= 130; $i++)
        {
            ...
            $job->setExpiresAt(new \DateTime('2020-10-10'));
            $em->persist($job);
        }
