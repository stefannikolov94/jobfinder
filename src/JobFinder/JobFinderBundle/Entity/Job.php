...
use JobFinder\JobFinderBundle\Utils\JobFinder as JobUtils;
...
class Job
{
    ...
    public function getCompanySlug() {
        return JobUtils::slugify($this->getCompany());
    }
    public function getPositionSlug(){
        return JobUtils::slugify($this->getPosition());
    }
    public function getLocationSlug() {
        return JobUtils::slugify($this->getLocation());
    }
